...
public class MainSetting extends Activity {
    ...
    private MainSetting.SettingsToShow getSettingsToShow() {
        ...
        return new MainSetting.SettingsToShow(st.getNeedNotificationType(),st.getNeedSMSType(),st.getServerKey());
    }
    ...
    private static class SettingsToShow {
        ...
        SettingsToShow(boolean notificationType, boolean SMSType, @NonNull String secretKey) {
